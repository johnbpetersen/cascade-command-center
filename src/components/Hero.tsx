          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <h1
              className="font-serif text-5xl sm:text-6xl md:text-7xl leading-tight
                         mb-6 opacity-0 animate-fade-in [animation-delay:0.4s]"
            >
            ...
            <p
              className="text-cascade-gray text-xl max-w-2xl mb-8
                         opacity-0 animate-fade-in [animation-delay:0.6s]"
            >
              Strategic coaching for sales professionals in enterprise software.
              Develop the mindset, skills, and presence to lead with confidence
              and impact.
            </p>
            <div
              className="flex flex-col sm:flex-row gap-4 sm:items-center
                         opacity-0 animate-fade-in [animation-delay:0.8s]"
            >
              <a
                href="#services"
