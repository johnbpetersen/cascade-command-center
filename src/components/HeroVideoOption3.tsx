// src/components/HeroVideoOption3.tsx
import React from 'react';
import { ArrowRight } from 'lucide-react';

const HeroVideoOption3: React.FC = () => {
  return (
    <section
      id="hero"
    ...
    >
      ...
      <video
        ...
        src="/videos/hero-wolf-loop.mp4"
        autoPlay
        muted
        loop
        playsInline
      >
        <source src="/videos/hero-wolf-loop.mp4" type="video/mp4" />
...
export default HeroVideoOption3;