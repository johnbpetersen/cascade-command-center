// src/components/HeroVideoOption1.tsx
import React from 'react';
import { ArrowRight } from 'lucide-react';

const HeroVideoOption1: React.FC = () => {
  return (
    <section
      id="hero"
    ...
    >
      ...
      <video
        ...
        src="/videos/mountain-background.mp4"
        autoPlay
        muted
        loop
        playsInline
...
export default HeroVideoOption1;